...
const axios = {
  get: async (...args: any) => {
    try{
      const response = await axiosLibrary.get(...args)
      return response
    }catch(e: any){
      return e.response
    }
  ...
  post: async (...args: any) => {
    try{
      const response = await axiosLibrary.post(...args)
      return response
    }catch(e: any){
      return e.response
    }
  ...
  put: async (...args: any) => {
    try{
      const response = await axiosLibrary.put(...args)
      return response
    }catch(e: any){
      return e.response
    }
  ...
  delete: async (...args: any) => {
    try{
      const response = await axiosLibrary.delete(...args)
      return response
    }catch(e: any){
      return e.response
    }
